defmodule API.Monitoring do
  ...
  """
  def metrics_callback(%{resp_end: :undefined}), do:
    Logger.warn("Could not calculate response time due to server (error | timeout).")
  ...
  # defp _update_stat(stat, value, type \\ :counter) do
